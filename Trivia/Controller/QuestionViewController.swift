...
//  Trivia
//
//  Created by Jefferson Naranjo rodríguez on 20/09/22.
//
...
class QuestionViewController: UIViewController {
    ...
    private func rightAnswerTapped() {
        let alertYES = UIAlertController(title: "Excellent!", message: "Excellent", preferredStyle: .alert)
    ...
    private func wrongAnswerTapped() {
        let alertNO = UIAlertController(title: "Wrong!", message: "Sorry, you're wrong ", preferredStyle: .alert)
